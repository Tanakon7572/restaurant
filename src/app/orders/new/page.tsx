      ...
      {isDiyView && activeCat ? (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: '10px', marginBottom: '16px' }}>
          {availableItems.map(item => {
            ...
            return (
              <div key={item.id}
                style={{ borderRadius: 'var(--radius-sm)', border: '1px solid var(--c-border)', overflow: 'hidden', background: 'var(--c-surface)', display: 'flex', flexDirection: 'column', cursor: soldOut ? 'not-allowed' : 'pointer', minWidth: 0, position: 'relative', opacity: soldOut ? 0.6 : 1 }}
