  ...
  return (
    <div
      style={{
        ...
        borderRadius: '12px',
        border: `1.5px solid ${isPending ? 'oklch(0.80 0.14 80 / 0.40)' : 'oklch(0.72 0.115 240 / 0.40)'}`,
    ...
    >
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: accent,
          border: `1px solid ${isPending ? 'oklch(0.80 0.14 80 / 0.35)' : 'oklch(0.72 0.115 240 / 0.35)'}`,
        ...
        <div style={{
          ...
          <div>
            <Column
              ...
              color="var(--c-info)"
              accentBg="oklch(0.225 0.025 240)"
              icon={
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
